...
This function generates background noise data with specified parameters
such as the number of samples, number of dimensions, mean, and standard
deviation.
...
#> ✔ Background noise generation completed successfully!!!
#> # A tibble: 500 × 4
#>        x1     x2     x3     x4
#>     <dbl>  <dbl>  <dbl>  <dbl>
