test_that("gen_noise_dims() works", {
  ...
  testthat::expect_error(gen_noise_dims(n = -50, num_noise = 3, min_n = -0.01,
                                        max_n = 0.01))
  testthat::expect_error(gen_noise_dims(n = 50, num_noise = -3, min_n = -0.01,
                                        max_n = 0.01))
  testthat::expect_error(gen_noise_dims(num_noise = 3, min_n = -0.01,
                                        max_n = 0.01))
  testthat::expect_error(gen_noise_dims(n = 50, min_n = -0.01,
                                        max_n = 0.01))
