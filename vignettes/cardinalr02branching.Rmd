...
```{r}
curvy_tree_data <- curvy_tree_with_noise(n = 720, 
...
```{r}
tree_data <- tree_with_noise(n = 490, num_noise = 2, 
...
```{r}
seven_branch_data <- seven_branching_data_with_noise(n = 490, 
num_noise = 2, min_n = -0.05, max_n = 0.05)
...
```{r}
four_branch_data <- four_branching_data_with_noise(n = 880, 
num_noise = 2, min_n = -0.05, max_n = 0.05)
...
```{r}
eight_branch_data <- eight_branching_data_with_noise(n = 600, 
num_noise = 2, min_n = -0.05, max_n = 0.05)
...
```{r}
curvy_clust_data <- curvy_branching_cluster(n = 500, 
cluster_size_vec = c(200, 150, 150), num_noise = 2, 
min_n = -0.05, max_n = 0.05)
...
```{r}
curvy_branchingbkg_data <- curvy_branching_cluster_with_bkg_noise(n = 500, num_noise = 2, min_n = -0.5, max_n = 0.5)
...
```{r}
curvy_branching_data <- curvy_branching_with_noise(n = 500, 
num_noise = 2, min_n = -0.05, max_n = 0.05)
