...
```{r}
gau_data <- gaussian_clusters(sample_size = 300, with_seed = NULL, num_clusters = 5, 
...
## Dataset 6 (Different shape clusters)
...
## Dataset 7 (Sine curve with noise)
...
## Dataset 9 (three clusters data with extra noise dimensions)
...
## Dataset 10 (Torus with extra noise dimensions)
...
## Dataset 11 (Spiral with extra noise dimensions)
...
## Dataset 12 (Roman surface with extra noise dimensions)
...
## Dataset 13 (Roman surface with extra noise dimensions)
...
## Dataset 14 (Dini surface with extra noise dimensions)
...
## Dataset 15 (conic spiral with extra noise dimensions)
...
## Dataset 16 (S curve with a hole and extra noise dimensions)
...
```{r}
cluster_and_curvilinear__with_noise <- function(sample_size = 200, cluster_size_vec = c(50, 150), with_seed = NULL, num_of_noise_dim = 3,
    min_noise = -0.05, max_noise = 0.05) {
  # To check the seed is not assigned
  if (!is.null(with_seed)) {
    set.seed(with_seed)
...
```{r}
dataset67 <- cluster_and_curvilinear__with_noise(sample_size = 1500, cluster_size_vec = c(500, 1000), with_seed = NULL, num_of_noise_dim = 3,
    min_noise = -0.05, max_noise = 0.05)
