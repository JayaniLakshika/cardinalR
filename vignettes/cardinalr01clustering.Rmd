...
```{r}
gau_data <- gaussian_clusters(sample_size = 500, num_clusters = 5, 
mean_matrix = rbind(c(1,0,0,0), c(0,1,0,0), c(0,0,1,0), c(0,0,0,1), c(0,0,0,0)), 
var_vec = c(0.05, 0.05, 0.05, 0.05, 0.05), num_dims = 4, num_noise_dims = 2, 
...
```{r}
gau_diff_data <- gaussian_clusters_diff_points(sample_size = 500, 
...
num_dims = 6, num_noise_dims = 4, min_noise = -0.05, max_noise = 0.05)
...
```{r}
clust_diff_shape_data <- clusters_different_shapes(sample_size = 600, 
...
```{r}
clust_diff_shapep_data <- clusters_different_shapes_diff_num_points(sample_size = 600,
...
```{r}
clust_curvebkg_data <- cluster_and_curvilinear__with_noise_and_bkg_noise(sample_size = 660,
...
```{r}
one_doublet_data <- one_doublet_with_noise(sample_size = 330, 
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
three_doublet_data <- three_doublets_with_noise(sample_size = 630, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
one_doublet_clust_data <- one_doublet_four_clusters_with_noise(sample_size = 660,
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
one_doublet_diffv_data <- one_doublet_dfifferent_var_clusters_with_noise(sample_size = 390,
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
one_doublet_diff_data <- one_doublet_dfifferent_pattern_clusters_with_noise(sample_size = 630, 
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
two_doublet_para_data <- two_doublets_parallel_with_noise(sample_size = 660, 
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
one_doublet_data <- one_doublets_with_bkg_noise(sample_size = 500, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
two_doublet_data <- two_doublets_with_bkg_noise(sample_size = 500, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
two_nonlinear_data <- two_nonlinear_with_noise(sample_size = 500, num_noise_dims = 2,
...
```{r}
three_curv_data <- two_curvilinear_with_noise(sample_size = 500, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
three_curv_diff_data <- two_curvilinear_diff_with_noise(sample_size = 500, 
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
three_nonlinear_data <- three_nonlinear_with_noise(sample_size = 330, 
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
...
```{r}
three_mir_data <- three_cluster_mirror_with_noise(sample_size = 720, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
curve_clust_data <- cluster_and_curvilinear_with_noise(sample_size = 500, 
cluster_size_vec = c(150, 350), num_noise_dims = 2, min_noise = -0.05,
max_noise = 0.05)
...
```{r}
three_clust_data <- three_clusters_data_with_noise(sample_size = 660, num_dims = 6,
num_noise_dims = 2, min_noise = -0.05, max_noise = 0.05)
