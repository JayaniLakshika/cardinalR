...
```{r}
three_circ_data <- three_circulars_with_noise(n = 300, num_noise = 2, min_n = -0.05, max_n = 0.05)
...
```{r}
cell_cyc_data <- cell_cycle_with_noise(n = 300, num_noise = 2, min_n = -0.05, max_n = 0.05)
...
```{r}
curvy_cyc_data <- curvy_cell_cycle_with_noise(n = 300, num_noise = 2, min_n = -0.05, max_n = 0.05)
...
```{r}
linkdata <- link_data(n = 200, num_noise = 2, min_n = -0.05, max_n = 0.05)
