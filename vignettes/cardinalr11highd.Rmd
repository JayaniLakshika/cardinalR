...
```{r}
conic_data <- conic_spiral_with_noise(sample_size = 300, num_noise_dims = 2,
...
```{r}
dini_data <- dini_surface_with_noise(sample_size = 300, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
roman_data <- roman_surface_with_noise(sample_size = 300, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
spiral_data <- spiral_with_noise(sample_size = 300, num_dims = 10, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
torus_data <- torus_with_noise(sample_size = 300, num_noise_dims = 2,
min_noise = -0.05, max_noise = 0.05)
...
```{r}
cube_data <- cube_3d_with_noise(num_of_effective_dims = 3, num_noise_dims = 2,
min_noise = -0.01, max_noise = 0.01)

cube_data$sample_size
