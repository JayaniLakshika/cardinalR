...
```{r}
conic_data <- conic_spiral_with_noise(n = 300, num_noise = 2,
...
```{r}
dini_data <- dini_surface_with_noise(n = 300, num_noise = 2,
min_n = -0.05, max_n = 0.05)
...
```{r}
roman_data <- roman_surface_with_noise(n = 300, num_noise = 2,
min_n = -0.05, max_n = 0.05)
...
```{r}
spiral_data <- spiral_with_noise(n = 300, num_dims = 10, num_noise = 2,
min_n = -0.05, max_n = 0.05)
...
```{r}
torus_data <- torus_with_noise(n = 300, num_noise = 2,
min_n = -0.05, max_n = 0.05)
...
```{r}
cube_data <- cube_3d_with_noise(num_of_effective_dims = 3, num_noise = 2,
