...
```{r}
scurve_data <- s_curve(sample_size = 500, num_noise_dims = 2, 
...
```{r}
scurve_hole_data <- s_curve_hole(sample_size = 500, num_noise_dims = 2, 
             min_noise = -0.05, max_noise = 0.05)
...
```{r}
two_scurve_data <- two_s_curves_with_noise(sample_size = 500, num_noise_dims = 2, 
                        min_noise = -0.05, max_noise = 0.05)
...
```{r}
mirror_scurve_data <- mirror_s_curves_with_noise(sample_size = 500, num_noise_dims = 2, 
                           min_noise = -0.05, max_noise = 0.05)
...
```{r}
two_scurveh_data <- two_s_curve_hole_with_noise(sample_size = 500, num_noise_dims = 2, 
                            min_noise = -0.05, max_noise = 0.05)
two_scurveh_data$sample_size
