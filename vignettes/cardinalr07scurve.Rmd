...
```{r}
scurve_data <- s_curve(n = 500, num_noise = 2, 
...
```{r}
scurve_hole_data <- s_curve_hole(n = 500, num_noise = 2, 
             min_n = -0.05, max_n = 0.05)
...
```{r}
two_scurve_data <- two_s_curves_with_noise(n = 500, num_noise = 2, 
                        min_n = -0.05, max_n = 0.05)
...
```{r}
mirror_scurve_data <- mirror_s_curves_with_noise(n = 500, num_noise = 2, 
                           min_n = -0.05, max_n = 0.05)
...
```{r}
two_scurveh_data <- two_s_curve_hole_with_noise(n = 500, num_noise = 2, 
                            min_n = -0.05, max_n = 0.05)
two_scurveh_data$n
